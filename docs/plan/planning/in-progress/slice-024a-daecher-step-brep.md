...
- [ ] **DoD-1 — Dach-B-Rep via Vernähung, fail-closed (`occ_solids`-Helfer; HIGH-1).** Ein geteilter,
      ...
      **`BRepCheck_Analyzer.IsValid()`** (geschlossene, gültige Shell); **ungültig/offen → übersprungen**
      ...
      nicht im Test.
- [ ] **DoD-2 — `buildSolidCompound` ergänzt die Dach-Solids.** Im `StepExportAdapter` fügt
...
- [ ] **DoD-3 — Spec §1 [`LH-FA-IO-005.a`](../../../../spec/lastenheft.md#lh-fa-io-005): Dach-Hälfte auf B-Rep geschärft
...
- [ ] **DoD-4 — AK-Tests + OCC-freie Wasserdichtheits-Invariante ([MR-009](../../../../harness/conventions.md#mr-009--geometrielastiges-code-review-vor-welle-closure)-Orakel; HIGH-1/LOW-3).**
...
- [ ] **DoD-5 — Schicht + Gates + Reviews + Closure.** `arch-check` **Regel C** deckt die OCC-Nutzung (kein
...
*(wird bei Closure gefüllt — Closure-Kriterien beobachtbar, Lerneintrag, Nachfolge: 024b Treppen)*
