...
- ✓ **slice-017f** — **EVL-Listen** (EVL-004/005/006) — **schließt das EVL-Modul**:
  `EvaluatePort.materialList()` (je effektivem Material Anzahl + Menge = Σ
  Netto-Volumen über Wand+Decke, Reuse `effectiveMaterial`/`volume_geometry`;
