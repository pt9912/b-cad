...
**Status:** in-progress. **Vor Start:** [MR-006](../../../../harness/conventions.md#mr-006--unabhängiges-plan-review-vor-implementierungs-start)-Plan-Review (HIGHs blockieren Start).
**Geometrieschwer** (neue B-Rep-Solid-Konstruktion im Geometrie-Adapter) → zusätzlich
[MR-009](../../../../harness/conventions.md#mr-009--geometrielastiges-code-review-vor-welle-closure)-Geometrie-Code-Review **vor Welle-Closure** (HIGHs blockieren Closure).
...
- [ ] **DoD-1 — Kern-Query `stairStepBoxes` (eine Box-Wahrheit; LOW-2).** Eine **pure Kern-Query**
...
- [ ] **DoD-2 — Treppen-B-Rep via analytische Box-Solids im Adapter.** `buildSolidCompound` (im
...
- [ ] **DoD-3 — Geländer aus dem STEP-B-Rep ausgelassen (explizit, MED-2).** Das Geländer ist **render-only**
      ...
      Teilumfang).
- [ ] **DoD-4 — Spec §1 [`LH-FA-IO-005.a`](../../../../spec/lastenheft.md#lh-fa-io-005): Treppen-Hälfte geschärft, Lücke
...
- [ ] **DoD-5 — AK-Tests + OCC-freie Invarianten ([MR-009](../../../../harness/conventions.md#mr-009--geometrielastiges-code-review-vor-welle-closure)-Orakel; LOW-3).** Die STEP-Fixture in
...
- [ ] **DoD-6 — Schicht + Gates + Reviews + Closure.** `arch-check` **Regel C** deckt die OCC-Nutzung (kein
...
*(wird bei Closure gefüllt — Closure-Kriterien beobachtbar, Lerneintrag, Nachfolge: PDF/PNG + Welle-4-
Verifikation → M4)*
