...
Implementierung
([**009b**](../in-progress/slice-009b-raumerkennung-implementierung.md)) — Ergebnis
...
| diese Datei + [`slice-009b`](../in-progress/slice-009b-raumerkennung-implementierung.md) | ändern | Frontmatter-`adr_refs` um ADR-0007 ergänzen, sobald die Datei existiert |
...
- DoD vollständig, ADR-0007 `Accepted`, `make gates` grün,
  Closure-Notiz geschrieben → [slice-009b](../in-progress/slice-009b-raumerkennung-implementierung.md)
  wird startbar.
