...
| [0015](0015-dxf-backend.md) | DXF-Import/-Export-Backend (**selbst getragener DXF-Subset-Codec** im IO-Adapter, **Option D** — kein Bibliotheks-Zukauf, ADR-0004-konform; **io-resident** wie IFC, **Regel A+B** isolieren („Regel F gegenstandslos"); **2D-Grundriss** = gerade Wand-Achsen je Geschoss-`LAYER`; atomar [`E-IO-001`](../../../spec/spezifikation.md#4-fehler-codes-und-logging-felder)/[`E-IO-003`](../../../spec/spezifikation.md#4-fehler-codes-und-logging-felder); OCC kann **kein** DXF; PDF/PNG = Schwester-ADR) | **Proposed** (2026-06-17) | [LH-FA-IO-003](../../../spec/lastenheft.md#lh-fa-io-003)/004, [OBJ-005](../../../spec/lastenheft.md#3-projektziele), ADR-0001/0002/0004/0005/0013/0014 |
