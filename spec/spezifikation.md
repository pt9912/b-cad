...
**Geometrie-Bereitstellung (Kern-Naht).** Driven Export-Adapter **serialisieren nur** — sie
leiten **keine** Domänen-Geometrie ab. Der Kern berechnet die abgeleitete Bauteil-Geometrie und
