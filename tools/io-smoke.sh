...
# Datei. IFC/DXF round-trippen (Export + Re-Import); STEP/STL sind export-only.
#
...
echo "io-smoke ok: IFC/DXF Export+Re-Import + STEP/STL Export — alle exit 0, Dateien nicht leer"
